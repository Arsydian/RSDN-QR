...
const INITIAL_PAYLOADS: QrPayloadState = {
  ...
  email: { email: 'contact@arsydian.com', subject: 'Consultation Request', body: 'Hello Arsydian team,' },
  phone: { phone: '+15550192834' },
  sms: { phone: '+15550192834', message: 'Hi, I would like to schedule an IT security review.' },
  wifi: { ssid: 'Arsydian_Secure_5G', password: 'NetworkSecure2026!', encryption: 'WPA', hidden: false },
  vcard: {
    firstName: 'Alex',
    lastName: 'Morgan',
    ...
    phoneWork: '+1 (555) 765-4321',
    email: 'alex@arsydian.com',
    url: 'https://arsydian.com',
    street: '100 Tech Square, Suite 400',
    city: 'Boston',
    state: 'MA',
    zip: '02108',
    country: 'USA',
    note: 'Enterprise IT Security & Network Design',
  },
  whatsapp: { phone: '15550192834', message: 'Hello Arsydian, I need assistance with our infrastructure.' },
  crypto: { currency: 'bitcoin', address: 'bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdq', amount: '0.025', message: 'Invoice #2049' },
  event: {
    title: 'Arsydian Cybersecurity Briefing',
    startDate: '2026-09-15T14:00',
    endDate: '2026-09-15T15:30',
    location: 'Virtual Event',
    description: 'Quarterly zero-trust security & network compliance briefing.',
  },
};
